...
- Confidence: candidate
- Skip when: automated reviewer flags an export, component, helper, or file as unused, and `gt ls -s`, upper-stack diffs, or PR context shows it is used by a later PR in the stack.
