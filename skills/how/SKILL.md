...
2. Spawn one read-only explorer using the How explorer route and `references/explorer-prompt.md`. Add another explorer only for a separate subsystem or runtime lane.
