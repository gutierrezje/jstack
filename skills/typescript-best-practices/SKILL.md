...
| Boundary validation | Parse external data at the boundary into a named domain type. `Record<string, unknown>`, however spelled, stops at that parse. Trust types inside. See [$principle-boundary-discipline](../principle-boundary-discipline/SKILL.md). |
