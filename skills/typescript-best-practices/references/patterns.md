...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see [$principle-type-system-discipline](../../principle-type-system-discipline/SKILL.md) and [$principle-boundary-discipline](../../principle-boundary-discipline/SKILL.md).
...
Validate once where data crosses in; trust types inside. See [$principle-boundary-discipline](../../principle-boundary-discipline/SKILL.md).
