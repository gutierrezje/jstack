...
3. Always inspect source control locally. Use the Why investigator route for up to three read-only investigators covering distinct available external categories, using the matching file under `references/sources/` and `references/investigator-prompt.md`.
